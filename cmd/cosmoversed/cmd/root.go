...
import (
	...
	"github.com/charleenfei/cosmoverse-workshop/app/params"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithViper("cosmoverse-workshopd") // In simapp, we don't use any prefix for env variables.

	rootCmd := &cobra.Command{
		Use:   "cosmoverse-workshopd",
		Short: "cosmoverse workshop eightball chain binary",
