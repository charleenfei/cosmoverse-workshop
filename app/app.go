...
import (
	...
	appparams "github.com/charleenfei/cosmoverse-workshop/app/params"
...
var (
	...
	maccPerms = map[string][]string{
		...
		eightballmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
		icatypes.ModuleName:             nil,
		// this line is used by starport scaffolding # stargate/app/maccPerms
	}
	allowedReceivingModAcc = map[string]bool{
		eightballmoduletypes.ModuleName: true,
	}
)
...
func New(
	...
	var (
		...
		// no underlying auth module for ICA in v6
		icaControllerIBCModule = eightballmodule.NewIBCMiddleware(icacontroller.NewIBCMiddleware(nil, app.ICAControllerKeeper), app.EightballKeeper)
	)
